...
(with cran.qry, can.all.1400 in the same directory)

Other:
I use WordNetLemmatizer to trim the words 

tf = log(num_ins / sentence_length)

I got MAP around 0.26 if I don't eliminate all the 0s, but in order to meet the standard on gradescope I cut off all the cosine similarity below 0.28
